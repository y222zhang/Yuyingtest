$(function() {
	...
	async function getDoc(){
		...
		doc.setFontSize(24);
		doc.text('Strategy Compare Results', 180, 80);
		doc.setFontSize(20);
		doc.text('Essential Figures', 50, 120);
		doc.setFontSize(16);
		doc.text('Section 1: Basic Comparison', 50, 150);
		doc.addImage( catchChartImg, 'jpg', 50, 200,500, 320, undefined, 'none');
		doc.setFontSize(12);
		doc.text("The comparison of the median total catches during the projection period.",50,540);
		doc.addPage();
		doc.addImage(SSBGulfChartImg, 'jpg', 50, 50, 500, 320, undefined, 'none');
		doc.setFontSize(12);
		doc.text("The comparison of the median total spawning stock biomass (SSB) during the projection period.",50,390);
		doc.addImage(catch20ChartImg, 'jpg', 120, 450 ,350, 320, undefined, 'none');
		doc.setFontSize(12);
